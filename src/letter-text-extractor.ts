...
import { LetterTextFragment } from './letter-text-fragment';
 ...
 * @returns Returns the LetterTextFragment object.
 */
export function extractSingleLetter(extractInfo: Readonly<ExtractInfo>): LetterTextFragment | null {
